...
let gatewayName = gatewayButton.getAttribute('gatewayName');
...
PNGateway.gatewayName = gatewayName;
...
gatewayButton.addEventListener('click', function(evt) {
  ...
  window.location.href = 'planetnine://gateway/details?gatewayname=' + gatewayName + 
       '&partnerName=' + partnerName + '&gatewayurl=https://www.plnet9.com/index2.html&totalPower=' + totalPower + '&' +
...
Object.defineProperty(PNGateway, 'callback', {
  set: function(callback) {
    ...
    axios.put('https://www.plnet9.com/user/userId/' + params.userId + '/power/gateway/' + gatewayName, powerObj)
    //axios.put('http://10.47.110.189:3000/user/userId/' + params.userId + '/power/gateway/' + gatewayName, powerObj)
    .then(resp => {
      if(resp.status == 200) {
